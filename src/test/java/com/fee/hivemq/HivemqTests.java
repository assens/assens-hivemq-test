...
class HivemqTests {
  ...
  void testAtMostOnce(final RepetitionInfo repetitionInfo) throws MqttException {
  ...
  void testAtLeastOnce(final RepetitionInfo repetitionInfo) throws MqttException {
  ...
  void testExactlyOnce(final RepetitionInfo repetitionInfo) throws MqttException {
    actAndAssert(repetitionInfo, 2);
  }

  private void actAndAssert(final RepetitionInfo repetitionInfo, final int qos) throws MqttException {
    // Act
  ...
  private void logAftePublish(final RepetitionInfo repetitionInfo, final int qos) {
